...
public class MailSenderUtil {
	private static final Logger logger=LogManager.getLogger(MailSenderUtil.class.getName());
		 ...
		 */
		private static ScheduledExecutorService quickService = Executors.newScheduledThreadPool(NO_OF_QUICK_SERVICE_THREADS); // Creates a thread pool that reuses fixed number of threads(as specified by noOfThreads in this case).
	   
	    public static  void sendMail(JavaMailSender javaMailSender,String toReceiver,String subject,String message) throws MailException{		
